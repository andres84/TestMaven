...
import com.mycompany.Vistas.util.JsfUtil;
import com.mycompany.Vistas.util.PaginationHelper;
import com.mycompany.Controlador.LibroFacade;
...
public class LibroController implements Serializable {
    ...
    @EJB
    private com.mycompany.Controlador.LibroFacade ejbFacade;
    ...
    public Libro getLibro(java.lang.String id) {
